...
public class AudioControl : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        master.GetFloat("SFX_Volume", out outSFX);
        ...
        master.GetFloat("BackgroundVolume", out outAudio);
    ...
    public void SliderChanged(Slider slider)
    {
        ...
        {
            master.SetFloat("SFX_Volume", slider.value);
        }
        else if (slider == musicSlider)
        {
            master.SetFloat("BackgroundVolume", slider.value);
        }
    }
}